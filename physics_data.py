...
SPIDER_BASE_ACTION_PER_TIME = 4.0
...
MACHINE_GUN_BULLET_SPEED_MPS = 100.0
MACHINE_GUN_BULLET_DAMAGE = 15.0
MACHINE_GUN_FIRE_RATE = 0.1  # 초 단위

WAVE_BASE_TIME = 30.0  # 초 단위
WAVE_MAX_TIME = 30.0

PLAYER_RUN_SPEED_KMPH = 30.0  # Km / Hour
PLAYER_RUN_SPEED_PPS = (PLAYER_RUN_SPEED_KMPH * 1000.0 / 3600.0) * PIXEL_PER_METER

PLAYER_BASE_FRAMES = 13
PLAYER_BASE_ACTION_PER_TIME = 4.0
...
HOOVER_LASER_DAMAGE_PER_TIME = 1000
