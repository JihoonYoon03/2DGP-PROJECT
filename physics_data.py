...
SPIDER_TURRET_ROTATE_SPEED = 75.0 * UPGRADE_TURRET_ROTATE_SPEED  # 도 단위 / 초

MACHINE_GUN_BULLET_SPEED_MPS = 20.0
UPGRADE_GUN_BULLET_DAMAGE = 1.0
MACHINE_GUN_BULLET_DAMAGE = 120.0 * UPGRADE_GUN_BULLET_DAMAGE  # 한 발당 데미지
UPGRADE_GUN_FIRE_RATE = 1.0
MACHINE_GUN_FIRE_RATE = 0.25 * UPGRADE_GUN_FIRE_RATE  # 초 단위
UPGRADE_GUN_SPREAD = 1.0
MACHINE_GUN_SPREAD_RAD = 5.0 * UPGRADE_GUN_SPREAD * math.pi / 180  # 라디안 단위
...
HOOVER_LASER_DAMAGE_PER_TIME = (100 + UPGRADE_LASER_DAMAGE) * UPGRADE_LASER_DAMAGE_PERCENT  # 초 단위 데미지
